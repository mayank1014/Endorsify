...
/** @private */
export declare const sharedTooltipRender: string;
/** @private */
export declare const seriesRender: string;
/** @private */
export declare const axisLabelRender: string;
/** @private */
export declare const axisLabelClick: string;
/** @private */
...
/** @private */
export declare const chartDoubleClick: string;
/** @private */
export declare const pointClick: string;
/** @private */
export declare const pointDoubleClick: string;
/** @private */
...
/** @private */
export declare const beforeResize: string;
/** @private */
...
/** @private */
export declare const bulletChartMouseClick: string;
/** @private */
